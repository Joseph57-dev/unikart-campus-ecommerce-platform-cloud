...
<body>
    ...
    <div class="modern-layout">
        <button id="category-toggle" class="category-toggle-btn"><i class="fas fa-bars"></i> Categories</button>
        <div id="sidebar-overlay" class="sidebar-overlay"></div>
        <aside id="modernSidebar" class="modern-sidebar">
            <div class="sidebar-header">
                <h3>Categories</h3>
                <button id="sidebar-collapse-btn" class="sidebar-collapse-btn" aria-label="Collapse categories">
        ...
        <main class="modern-content">
            ...
            <div class="modern-products-grid">
                <?php if($select_products->rowCount() > 0): ?>
                    ...
                    ?>
                        <form action="" method="post" class="modern-product-card" data-category="<?= $fetch_product['category'] ?>">
